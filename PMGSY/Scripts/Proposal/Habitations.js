...
function ShowHabitations(IMS_PR_ROAD_CODE) {
    ...
    jQuery("#tbHabitation").jqGrid({
        ...
        datatype: "json",
        mtype: "POST",
        colNames: ['HabCode', 'Block', 'Village', 'Habitation', "SC/ST Population", "Population", "Delete", "Create New Cluster", "Cluster", "Edit Cluster", "ClusterCode"],
        colModel: [
            ...
            { name: 'Village', index: 'Village', width: 140, sortable: false, align: "center" },
            ...
            { name: 'EditCluster', index: 'EditCluster', width: 150, sortable: false, align: "center", edittype: "select" },
        ...
        loadComplete: function () {
            ...
            if ($("#PMGSYScheme").val() == 2 || $("#PMGSYScheme").val() == 5) {
...
function DeleteHabitation(IMS_PR_RODE_CODE, IMS_HAB_CODE) {
    if (confirm("Are you sure to UnMap the Habitaion ?")) {
        $.ajax({
