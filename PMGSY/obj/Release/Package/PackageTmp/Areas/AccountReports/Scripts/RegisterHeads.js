...
$(document).ready(function () {
    ...
    $("#btnView").click(function () {
        ...
        if ($("#frmRegisterHead").valid()) {
            ...
            $.ajax({
                type: 'POST',
                url: '/AccountReports/Account/ListRegisterDetails?' + $.param({ Month: $("#ddlMonths option:selected").val(), Year: selectedYear, HeadId: $("#ddlHeads option:selected").val(), SRRDACode: $("#ddlSRRDAPIU option:selected").val(), ReportType: "D", DPIUCode: $("#ddlPIU option:selected").val(), FundingAgencyCode: $("#ddlAgency option:selected").val(), HeadName: $("#ddlHeads option:selected").text(), HeadCategoryId: $("#HeadCategoryId").val() }),
                async: false,
                cache: false,
    ...
    $("#ddlSRRDAPIU").change(function () {
        ...
        FillInCascadeDropdown(null, "#ddlPIU", "/AccountReports/Account/PopulateDPIUOfSRRDA?id=" + $("#ddlSRRDAPIU").val());
