...
function LoadInspDetailsList(PersonCode) {
    ...
    jQuery("#tbCDWorksList").jqGrid({
        url: '/RCTRC/RCTRC/GetRCTRCSuggestionList',
        datatype: "json",
        mtype: "POST",
        postData: { postdataPersonID: personIDSwitch },
       // postData: { RSACode: RSACode },
        colNames: ['Person Name','Suggestion', 'Status'],
        colModel: [
                            { name: 'Person_NAME', index: 'Person_NAME', height: 'auto', width: 400, align: "left", search: false },
                            { name: 'Suggestion_Name', index: 'Suggestion_Name', height: 'auto', width: 300, align: "left", search: false },
                            { name: 'Status_Suggestion', index: 'Status_Suggestion', height: 'auto', width: 250, align: "center", search: false },
                         //   { name: 'Present', index: 'Present', height: 'auto', width: 250, align: "left", search: false },
                           // { name: 'Plans', index: 'Plans', height: 'auto', width: 250, align: "left", search: false },
        ...
        sortorder: "asc",
        caption: "&nbsp;&nbsp; List of Suggestion Details",
        height: 'auto',
        hidegrid: true,
        rownumbers: true,
