...
/*
        ...
        * Name          :   StaLSBSanctionViewModel.cs
        * Description   :   This View Model is Used in STA LSB Details Views in StaLSBSanctionViewModel.cshtml
        * Author        :   Shyam Yadav
...
{
    public class StaLSBSanctionViewModel
    {
        ...
        [Required]
        [RegularExpression(@"^[a-zA-Z0-9 ]+$", ErrorMessage = "Invalid STA,Can only contains Alphabets values")]
