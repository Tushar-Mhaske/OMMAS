...
$(document).ready(function () {
    ...
    $.validator.unobtrusive.parse($('#frmTourPayment'));
    ...
    $("#btnSave").click(function () {
        ...
        if ($("#frmTourPayment").valid()) {

            $.ajax({

                url: '/QualityMonitoring/AddTourPaymentDetails',
                type: 'POST',
                catche: false,
                data: $("#frmTourPayment").serialize(),
                beforeSend: function () {
                    blockPage();
                },
                ...
                success: function (response) {
                    ...
                    if (response.success === undefined) {
                        $("#dvTourPaymentForm").html(response); //error 
                        unblockPage();
                    }
    ...
    $("#btnUpdate").click(function () {
        ...
        if ($("#frmTourPayment").valid()) {
            ...
            $.ajax({
                url: '/QualityMonitoring/UpdateTourPaymentDetails/',
                type: 'POST',
                catche: false,
                data: $("#frmTourPayment").serialize(),
                beforeSend: function () {
                ...
                success: function (response) {
                    ...
                    if (response.success === undefined) {
                        $("#dvTourPaymentForm").html(response);
                        unblockPage();
                    } else if (response.success) {
    ...
    $("#btnReset").click(function () {
        ...
        $('#lblPaymentTypeNumber').text("Chegue Number");
