...
namespace PMGSY.Models
{
    ...
    public partial class EFORM_QM_CHILD_BASECOURSE_UCS_DETAILS_LAYER2
    {
        public int BCUCS_ID { get; set; }
        ...
        public virtual EFORM_QM_BASE_COURSE_II EFORM_QM_BASE_COURSE_II { get; set; }
