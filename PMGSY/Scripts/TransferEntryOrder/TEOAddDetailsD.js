...
$(document).ready(function () {
                ...
                success: function (data) {
                    ...
                    if (data.CON_REQ == "Y") {
                        if ($("#trddlDistrictD").css('display') != "none" && $("#ddlDistrictD").val() != 0) {
                            ...
                            if (parentTxnId == 3100) {
                                FillInCascadeDropdown(null, '#ddlHeadContractorD', "/TEO/PopulateContractorWithNoOption/" + $("#ddlDistrictD").val());
                            ...
                            if (parentTxnId == 3100) {
                                FillInCascadeDropdown(null, '#ddlHeadContractorD', "/TEO/PopulateContractorWithNoOption/");
                    ...
                    if (aggD == "Y") {
                        if ($("#ddlDistrictD").val() == 0) {
                            ...
                            //FillInCascadeDropdown(null, '#ddlHeadAgreementD', "/TEO/PopulateAgreement/" + $("#ddlDistrictD").val() + "$" + $("#ddlHeadContractorD").val());
                             ...
                             //below code Added on 13-10-2022
                            if (parentTxnId == 3100 && $("#ddlHeadContractorD option:selected").val() == "-1") {
                                FillInCascadeDropdown(null, '#ddlHeadAgreementD', "/TEO/PopulateAgreementWithNoOption/" + $("#ddlDistrictD").val() + "$" + $("#ddlHeadContractorD").val());
                            } else {
                                FillInCascadeDropdown(null, '#ddlHeadAgreementD', "/TEO/PopulateAgreement/" + $("#ddlDistrictD").val() + "$" + $("#ddlHeadContractorD").val());
                            }
                        }
    ...
    $("#ddlHeadAgreementD").change(function () {
        if (roadD == "Y") {
            ...
            //Below code Added on 13-10-2022
            if (parentTxnId == 3100 && $("#ddlHeadAgreementD option:selected").val() == "-1") {

                FillInCascadeDropdown(null, '#ddlHeadRoadD', "/TEO/PopulateRoadWithNoOption/" + $("#ddlHeadAgreementD option:selected").val() + "$0$" + year + $("#ddlHeadContractorD option:selected").val() + "?" + $.param({ AGREEMENT_NUMBER: $("#ddlHeadAgreementD option:selected").text() }));
