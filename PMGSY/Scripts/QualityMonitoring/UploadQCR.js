...
function LoadExecutionGrid() {
    ...
    jQuery("#tbExecutionList").jqGrid({
        ...
        colNames: ['Block', 'Sanctioned Year', 'Batch', 'Package No.', 'Road Code', 'Work Name', 'Road/LSB Cost (In Lacs)', 'Road Length(in Kms)/LSB Length(int Mtrs)', 'Maintenance Cost(in Lacs)', 'Proposal Type', 'Upload QCR Part-I PDF'],
        colModel: [
   ...
   $('#divAddQCR').load("/QualityMonitoring/AddQCR?idtemp=" + urlparameter, function () {
         ...
         $('#divListExecutionPDF').append(function () {                                             
             ...
             jQuery("#tbExecutionListPDF").jqGrid({
                 ...
                 async: false,
                 cache: false,               
                 colNames: ['District', 'Block', 'Year', 'Batch', 'Package No.', 'Proposal Type', 'Work Name', 'Work Started', 'Uploaded Date', 'Remark', 'QCR Part-I Grading By SE', 'QCR Part-I Grading By SQC', 'View', 'Delete', 'Finalize'],
                 colModel: [
    ...
    $('#divAddQCR').load("/QualityMonitoring/AddQCR?idtemp=" + urlparameter, function () {
        ...
        $('#divListExecutionPDF').append(function () {
            ...
            jQuery("#tbExecutionListPDF").jqGrid({
                ...
                async: false,
                cache: false,
                colNames: ['District', 'Block', 'Year', 'Batch', 'Package No.', 'Proposal Type', 'Work Name', 'Work Started',/* 'QCR Part 1 PDF',*/ 'Uploaded Date', 'Remark', 'QCR Part-I Grading By SE', 'QCR Part-I Grading By SQC', 'View'/*, 'Delete', 'Finalize'*/],
                colModel: [
