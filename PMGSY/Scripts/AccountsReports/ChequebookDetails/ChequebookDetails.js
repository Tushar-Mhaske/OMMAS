...
//        $("#ddlMonth option:nth(" + month + ")").attr("selected", "selected");
    ...
    $("#ddlSRRDA").change(function () {
        ...
        var adminNdCode = $('#ddlSRRDA option:selected').val()+"$A";

        $.ajax({
            url: '/AccountsReports/PopulateDPIU/' + adminNdCode,
            type: 'POST',
            catche: false,
    ...
    $("#btnViewDetails").click(function () {
       ...
       // if (ValidateForm() == true) {
            $.ajax({
                type: 'POST',
                url: '/AccountsReports/ShowChequebookDetails/',
    ...
    $("#ddlDPIU").change(function () {
        ...
        $.ajax({
            type: 'POST',
            url: '/AccountsReports/GetChequebookSeriesByAdminNdCode?paramAdminNdCode=' + AdminNdCode,
            async: false,
            cache: false,
            success: function (data) {
