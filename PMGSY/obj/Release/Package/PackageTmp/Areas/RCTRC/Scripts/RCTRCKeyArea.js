...
function LoadInspDetailsList(PersonCode) {
    ...
    jQuery("#tbCDWorksList").jqGrid({
        url: '/RCTRC/RCTRC/GetRCTRCKeyAreaList',
        datatype: "json",
        mtype: "POST",
        postData: { postdataPersonID: personIDSwitch },
       // postData: { RSACode: RSACode },
        colNames: ['Person Name','Key Areas of Work', 'Past Experience', 'Present Work','Plan for next 5 Year'],
        colModel: [
                            { name: 'Person_NAME', index: 'Person_NAME', height: 'auto', width: 400, align: "left", search: false },
                            { name: 'Work_NAME', index: 'Work_NAME', height: 'auto', width: 300, align: "left", search: false },
                            { name: 'Past', index: 'Past', height: 'auto', width: 250, align: "left", search: false },
