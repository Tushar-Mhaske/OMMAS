...
{
    public class FundReleaseModel
    {

        public FundReleaseModel()
        {
            ...
            AgencyList = commonFunctions.PopulateMasterAgency(true);
            TypeList = new List<SelectListItem>();
            TypeList.Add(new SelectListItem { Text = "All", Value = "%" });
            TypeList.Add(new SelectListItem { Text = "Central", Value = "C" });
            TypeList.Add(new SelectListItem { Text = "State Government", Value = "S" });
            Type = "%";

            FundTypeList = new List<SelectListItem>();
            FundTypeList.Add(new SelectListItem { Text = "All", Value = "%" });
            FundTypeList.Add(new SelectListItem { Text = "Program Fund", Value = "P" });
            FundTypeList.Add(new SelectListItem { Text = "Administrative Fund", Value = "A" });
            FundTypeList.Add(new SelectListItem { Text = "Maintenance Fund", Value = "M" });
            FundType = "%";
