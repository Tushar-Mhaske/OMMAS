...
{
    public class HabitationScoreModel
    {

        public HabitationScoreModel()
            {
                ...
                if (StateCode == 0)
                {
                    ...
                    DistrictList.Insert(0, (new SelectListItem { Text = "Select District", Value = "-1", Selected = true }));
                }
                else
                {
                    ...
                    DistrictList.Find(x => x.Value == "-1").Text = "Select District";
                }
                BlockList = new List<SelectListItem>();
                if (DistrictCode == 0)
                {
