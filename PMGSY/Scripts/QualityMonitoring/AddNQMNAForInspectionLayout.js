...
$(document).ready(function () {
    ...
    //------------------ MultiSelect Code ----------------------------
    var rolecode = $("#rolecode").data('value');
    var arrMonitors = [];
    var arrDistCnt = 0;
    ...
    if (rolecode == 6) {
        ...
        var data = $("#nqmname").data('value');

        arrMonitors.push(data);
        //$("#AdminQmCode").select(data);

        $("#AdminQmCode").val(data);

    }
    else {
        //var role = '<%=PMGSYSession["RoleCode"] %>';document.getElementById('spam_key').value
