...
//Road List 
function RoadListGrid(districtCode, adminSchCode) {
    $("#tbSanctionRoadList").jqGrid('GridUnload');
    ...
    jQuery("#tbSanctionRoadList").jqGrid({
        ...
        datatype: "json",
        mtype: "POST",
        colNames: ["Work Priority", "Block", "Package", "Sanction Year", "Road / Bridge", "Type", "Length (Road-Km / LSB-Mtr)", "Contractor Name (Work Award Date)", "Commneced Date", "Completed Date",
                   "Scheme", "Assigned By", "NQM Inspection Date & Count", "SQM Inspection Date & Count","Technology", "Progress Status", "IsEnquiryHdn", "Is Enquiry", "AddWorkHdn", "Add Work"],
        colModel: [
                            ...
                            { name: 'TECHNOLOGY', index: 'TECHNOLOGY', width: 100, sortable: false, align: "center", search: false }, // Added by Sachin on 3 March 2020
                            ...
                            {
                                name: 'chkboxAdd', index: 'chkboxAdd', sortable: true, width: 40, align: 'center',
                                //formatter: "checkbox", formatoptions: { disabled: false },
                                editable: true, search: false,
                                edittype: "checkbox", editoptions: { value: "Y:N" }
                            },
        ],
        postData: { "districtCode": districtCode, "adminSchCode": adminSchCode },
        pager: jQuery('#dvSanctionRoadListPager'),
        rowNum: 10000,
        pgbuttons: false,
        pgtext: null,
