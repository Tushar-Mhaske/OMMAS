...
namespace PMGSY.Areas.ProposalSSRSReports.Models
{
    public class AgreementModel
    {
        ...
        public AgreementModel()
        {
            ...
            StatusList.Add(new SelectListItem { Text = "Dropped", Value = "D" });
            StatusList.Add(new SelectListItem { Text = "Reconsider", Value = "R" });
            StatusList.Add(new SelectListItem { Text = "Sanctioned", Value = "S" });
            StatusList.Add(new SelectListItem { Text = " Sanction Pending", Value = "N" });
            StatusList.Add(new SelectListItem { Text = "Unsactioned", Value = "U" });
            Status = "%";
