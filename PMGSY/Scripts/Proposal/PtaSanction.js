...
$(document).ready(function () {
    ...
    $("#trUnscrutinyRemarkPTA").hide();     //Hrishikesh

    //$("#trUnscrutinyDate").hide();
    $("#trUnscrutinyDatePTA").hide();   //Hrishikesh
    ...
    $(function () {
        ...
        $("#txtUnScrutinyDatePTA").datepicker(      //Hrishikesh
        {
            dateFormat: "dd-M-yy",
            changeMonth: true,
            changeYear: true,
        ...
        $("#txtUnScrutinyDatePTA").datepicker().attr('readonly', 'readonly');   //Hrishikesh
        $("#txtUnScrutinyDatePTA").datepicker("option", "maxDate", new Date()); //Hrishikesh
    ...
    $("#btnScrutinize").click(function (evt) {
        ...
        if ($("#PTA_SANCTIONED").val() != "N") {
            ...
            if (!$("#trScrutinyRemarkPTA").is(":visible")) {        //Hrishikesh

                //$("#trScrutinyRemark").show('slow');
                $("#trScrutinyRemarkPTA").show('slow');     //Hrishikesh
    ...
    $("#btnUnScrutinize").click(function (evt) {
        ...
        if ($("#MS_PTA_UnScrutinised_REMARKS").is(":visible") == false) {
            ...
            if (confirm("Are You Sure to UnScrutinize Proposal ?")) {
                ...
                $("#trUnscrutinyDatePTA").show("slow");   //Hrishikesh

                //$("#trUnscrutinyRemark").show("slow");
                $("#trUnscrutinyRemarkPTA").show("slow");   //Hrishikesh
