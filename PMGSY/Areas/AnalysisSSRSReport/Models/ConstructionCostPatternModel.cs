...
{
    public class ConstructionCostPatternModel
    {

        public ConstructionCostPatternModel()
        {
        ...
        [Required(ErrorMessage = "Please select Phase.")]
        [RegularExpression("^([0-9]+)$", ErrorMessage = "Year must be valid number.")]
        [CompareValidationWithConstCostFromYearToYear("FromYear", ErrorMessage = "To Year should not be less than value of From Year.")]
    ...
    public class CompareValidationWithConstCostFromYearToYear : ValidationAttribute, IClientValidatable
    {
        private readonly string PropertyName;

        public CompareValidationWithConstCostFromYearToYear(string propertyName)
        {
