...
{
    public class EFORM_PREVIOUS_INSP_DETAILS_PIU
    {
        ...
        [FieldType(PropertyType = PDFFieldType.TextBox)]
        [RegularExpression(pattern: @"^([0]?[0-9]|[12][0-9]|[3][01])/([0]?[1-9]|[1][0-2])/([0-9]{4})$", ErrorMessage = "Page-5 Item 5. EARLIER INSPECTIONS- Please Enter Valid date{in dd/mm/yyyy format} in  ")]
        ...
        public Nullable<decimal> ROAD_TO { get; set; }
         ...
         [Required(ErrorMessage = "Page-5: Item 5. EARLIER INSPECTIONS-Please enter Level of work at the time of inspection (5) of ")]
        [FieldType(PropertyType = PDFFieldType.TextBox)]
