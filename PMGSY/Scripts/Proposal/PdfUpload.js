...
$(document).ready(function () {
    $(function () {
        ...
        $('#fileupload').fileupload({
            // Commented on 14-02-2022 by Srishti Tyagi
...
function DeletePDFFileDetails(IMS_PR_ROAD_CODE, IMS_FILE_NAME) {
    
    if (confirm("Are you sure to delete the Proposal C Proforma PDF and it's details ? ")) {
        ...
        $.ajax({
            ...
            cache: false,
            data: {//PMGSY3
                IMS_PR_ROAD_CODE: IMS_PR_ROAD_CODE, IMS_FILE_NAME: IMS_FILE_NAME, ISPF_TYPE: ($('#Role').val() == 2 || $('#Role').val() == 3) ? 'P' : 'C', value: Math.random()
            },
            beforeSend: function () {
                blockPage();
            },
            ...
            success: function (response) {
                ...
                if (response.Success) {
                    ...
                    alert("Proposal C Proforma PDF and it's Details Deleted Succesfully.");
