...
function ListQualityFiles(IMS_PR_ROAD_CODE) {
    ...
    jQuery("#tbFilesList").jqGrid({
        ...
        datatype: "json",
        mtype: "POST",
        colNames: ["Image", "ATR (PIU)", "Download", "Delete"],
        colModel: [
                    { name: 'image', index: 'image', width: 400, sortable: false, align: "center", formatter: imageFormatter, search: false, editable: false },
                    ...
                    { name: 'Delete', index: 'Delete', width: 80, sortable: false, align: "center", editable: false, hidden:true }
        ...
        caption: "Details Uploaded By PIU",
        height: '100',
        sortname: 'Image',
        rownumbers: true,
