$(document).ready(function () {
   ...
   */
    if ($("#hdnOperation").val() == "U") {
        for (i = 0 ; i < 24; i++)//Total No of Activities = 24;
        {
            changeQuantity(i);
        }
    }
    ...
    $('#btnSubmit').click(function (evt) {
        ...
        if ($("#hdnOperation").val() == "A") {
            ...
            $.ajax({
                url: '/PMIS/PMIS/SaveBridgeProjectPlan',
                type: "POST",
                cache: false,
        ...
        if ($("#hdnOperation").val() == "U") {
            ...
            $.ajax({
                url: '/PMIS/PMIS/UpdatePMISBridgeProjectPlan',
                type: "POST",
                cache: false,
                data: JSON.stringify(DataToSend),
                contentType: 'application/json; charset=utf-8',
...
// on blur of each control 
//$(":text[class~=TAC]").blur(function () {
//    alert("in Blur");
//    var quantity = $('.QSqm').val()
//    var cost = $('.TAC').val()
//    if (quantity == 0 || cost == 0) {
//        alert(" Agreement Cost must be zero for zero quantity! ");
//    }
//});

//$(":input[id~=quantity"+i+"]").blur(function () {
//    alert("#quantity"+i.val());
//});
