...
{
    public class AnalysisDataProposalModel
    {

        public AnalysisDataProposalModel()
        {
        ...
        [Required(ErrorMessage = "Please select Phase.")]
        [RegularExpression("^([0-9]+)$", ErrorMessage = "Year must be valid number.")]
        [CompareValidationWithAnalysisDataFromYearToYear("FromYear", ErrorMessage = "To Year should not be less than value of From Year.")]
    ...
    public class CompareValidationWithAnalysisDataFromYearToYear : ValidationAttribute, IClientValidatable
    {
        private readonly string PropertyName;

        public CompareValidationWithAnalysisDataFromYearToYear(string propertyName)
        {
