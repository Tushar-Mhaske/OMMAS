...
function InspectionListGrid(stateCode, monitorCode, fromInspMonth, fromInspYear, toInspMonth, toInspYear, ROAD_STATUS, schemeType) {
    ...
    jQuery("#tb3TierInspectionList").jqGrid({
        ...
        colNames: ["Monitor", "State", "District", "Block", "Package", "Sanction Year", "Road Name", "Type",
                    ...
                    "Uploaded by", "View/Upload Report", "View Details", "View PDF"],
        colModel: [
                        { name: 'Monitor', index: 'Monitor', width: 70, sortable: false, align: "left" },
                        { name: 'State', index: 'State', width: 70, sortable: false, align: "center", search: false },
                        { name: 'District', index: 'District', width: 50, sortable: false, align: "left", search: false },
                        { name: 'Block', index: 'Block', width: 50, sortable: false, align: "left", search: false },
                        { name: 'Package', index: 'Package', width: 45, sortable: false, align: "left", search: false },
                        { name: 'SanctionYear', index: 'SanctionYear', width: 45, sortable: false, align: "center", search: false },
                        { name: 'RoadName', index: 'RoadName', width: 120, sortable: false, align: "left", search: false },
                        ...
                        { name: 'OverallGrade', index: 'OverallGrade', width: 70, sortable: false, align: "center", search: false },
                        { name: 'NoOfImagesUploaded', index: 'NoOfImagesUploaded', width: 40, sortable: false, align: "center", search: false },
                        { name: 'UploadBy', index: 'UploadBy', width: 30, sortable: false, align: "center", search: false },
                        { name: 'ViewReportPDF', index: 'ViewReportPDF', width: 30, sortable: false, align: "center", search: false },
        ...
        postData: { "stateCode": stateCode, "monitorCode": monitorCode, "fromInspMonth": fromInspMonth, "fromInspYear": fromInspYear, "toInspMonth": toInspMonth, "toInspYear": toInspYear, "ROAD_STATUS": ROAD_STATUS, "schemeType": schemeType },
