...
function ScheduledRoadListGrid(inspMonth, inspYear) {
    ...
    if ((inspYear > year) || (inspYear == year && inspMonth > month)) {
        ...
        jQuery("#tbMonitorsObsList").jqGrid({
            ...
            datatype: "json",
            mtype: "POST",
            colNames: ["State", "District", "Block", "Package", "Sanction Year", "Road Name", "Type", "Length (Road-Km / LSB-Mtr)", "Work Status", "Enquiry Inspection", "Scheme", "UnPlanned Schedule", "No. Of Photo Uploaded", "Fill Observations", "Upload File"],
            colModel: [
