...
{
    public class DistrictWiseRatingModel
    {

        public DistrictWiseRatingModel()
        {
            ...
            StatusList.Add(new SelectListItem { Text = "Award", Value = "A" });
            StatusList.Add(new SelectListItem { Text = "Complete", Value = "C" });
            StatusList.Add(new SelectListItem { Text = "Forest", Value = "F" });
            StatusList.Add(new SelectListItem { Text = "Legal", Value = "L" });
            StatusList.Add(new SelectListItem { Text = "Progress", Value = "P" });            
            Status = "%";
