...
namespace PMGSY.Extensions
{
    ...
    {
        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value)
        {
            return Datepicker(htmlHelper, id, value, false/*withoutScript*/);
        }

        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, bool withoutScript)
        {
            return Datepicker(htmlHelper, id, value, null/*datePickerOptions*/, withoutScript);
        }

        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, object datePickerOptions)
        {
            return Datepicker(htmlHelper, id, value, datePickerOptions, false/*withoutScript*/);
        }

        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, object datePickerOptions, bool withoutScript)
        {
            return Datepicker(htmlHelper, id, value, datePickerOptions, null/*htmlAttributes*/, withoutScript);
        }

        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, object dataPickerOptions, object htmlAttributes)
        {
            return Datepicker(htmlHelper, id, value, dataPickerOptions, htmlAttributes, false/*withoutScript*/);
        }

        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, object dataPickerOptions, object htmlAttributes, bool withoutScript)
        {
            // Create tag builder
            ...
            // Render tag
            return new MvcHtmlString(builder.ToString(TagRenderMode.SelfClosing) + (withoutScript == true ? string.Empty : "\n    " + RenderDatepicker(htmlHelper, new string[] { id }, dataPickerOptions)));
        }
        ...
        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, DatepickerTypes datePickerType, bool withoutScript)
        {
            return Datepicker(htmlHelper, id, value, datePickerType, null/*htmlAttributes*/, withoutScript);
        }

        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, DatepickerTypes datePickerType, object htmlAttributes)
        {
            return Datepicker(htmlHelper, id, value, datePickerType, htmlAttributes, false/*withoutScript*/);
        }

        public static MvcHtmlString Datepicker(this HtmlHelper htmlHelper, string id, string value, DatepickerTypes datePickerType, object htmlAttributes, bool withoutScript)
        {
            // Create tag builder
        ...
        public static MvcHtmlString RenderDatepicker(this HtmlHelper htmlHelper, string[] datePickerIds)
        {
            return RenderDatepicker(htmlHelper, datePickerIds, null/*datePickerOptions*/);
        }

        public static MvcHtmlString RenderDatepicker(this HtmlHelper htmlHelper, string[] datePickerIds, object datePickerOptions)
        {
            // Create tag builder
        ...
        public static MvcHtmlString RenderDatepicker(this HtmlHelper htmlHelper, string[] datePickerIds, DatepickerTypes datePickerType)
        {
            switch (datePickerType)
            {
                ...
                case DatepickerTypes.DisplayMonthAndYearMenus:
                    return RenderDatepicker(htmlHelper, datePickerIds, new { @changeMonth = true, @changeYear = true, @yearRange = "1950:2099", @dateFormat = "dd-M-yy" });
