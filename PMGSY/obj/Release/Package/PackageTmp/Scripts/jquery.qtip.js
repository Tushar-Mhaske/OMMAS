    ...
    */
    function QTip(target, options, id, attr) {
        ...
        function assignEvents() {
			...
			IE6 = (/MSIE (\d+\.\d+);/.test(navigator.userAgent));
            ...
            toggle: function (state, event) {
                ...
                function after() {
                    if (state) {
                        ...
                        if ((/MSIE (\d+\.\d+);/.test(navigator.userAgent))) { tooltip[0].style.removeAttribute('filter'); }
            ...
            reposition: function (event, effect) {
                ...
                // Use custom function if provided
                    ...
                    tooltip.queue(function (next) {
                        ...
                        if ((/MSIE (\d+\.\d+);/.test(navigator.userAgent))) { this.style.removeAttribute('filter'); }
    ...
    PLUGINS = QTIP.plugins = {
        ...
        offset: function (elem, container) {
			...
			quirks = (/MSIE (\d+\.\d+);/.test(navigator.userAgent)) && document.compatMode !== 'CSS1Compat',
    ...
    */
    ...
    function Tip(qTip, command) {
        ...
        function parseRadius(corner) {
			...
			moz = (/Firefox[\/\s](\d+\.\d+)/.test(navigator.userAgent)),
			prefix = moz ? '-moz-' : '',
        ...
        $.extend(self, {
            init: function () {
                var enabled = parseCorner() && (hasCanvas || (/MSIE (\d+\.\d+);/.test(navigator.userAgent)));
