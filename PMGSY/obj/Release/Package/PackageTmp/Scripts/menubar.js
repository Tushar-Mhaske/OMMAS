/*
 * THIS HAS BEEN MODIFIED FOR THIS JSFIDDLE EXAMPLE, PLEASE SEE THE OFFICIAL GITHUB
 * REPOSITORY FOR THE LATEST OFFICIAL SOURCE
 *
...
(function ($) {
    ...
    $.widget("ui.menubar", {
                ...
                if (menu.length) {
                    ...
                    input.bind("click.menubar focus.menubar mouseenter.menubar", function (event) {
                        ...
                        if (event.type === "click" && menu.is(":visible") && that.active && that.active[0] === menu[0]) {
                            ...
                            //*** modified - change the location to the href of the input link
                            if (that.options.activeTopLinks && inputHref) {
                                window.location = inputHref;
                            }
        ...
        next: function (event) {
            ...
            if (this.open && this.active.data("menu").active != null) {
        ...
        _move: function (direction, filter, event) {
            ...
            if (next.length) {
                ...
                if (this.open) {
                    ...
                    if (wrapItem.removeAttr("tabIndex")[0] != undefined) {
