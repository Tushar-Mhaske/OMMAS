...
{
    public class MLAProposalViewModel
    {   
        [UIHint("hidden")]
        ...
        /// <summary>
        /// Populate Year for Search criteria drop down
        /// </summary>
        ...
        /// <summary>
        /// Populate MLA Constituency for Search criteria drop down
        /// </summary>
        public SelectList Constituency
        {
            get
            {
                ...
                IMPMLAProposalDAL objDAL = new MPMLAProposalDAL();
                lstConstituency = objDAL.PopulateMLAConstatuency();
