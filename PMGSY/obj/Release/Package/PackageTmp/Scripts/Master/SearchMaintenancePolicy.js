...
$(document).ready(function () {
    $.validator.unobtrusive.parse('#frmSearchMaintenancePolicy');
    ...
    $.validator.unobtrusive.parse('#frmSearchMaintenancePolicy');
    $("#btnImsMaintenancePolicySearch").click(function () {
...
function searchDetails(stateCode, agencyCode) {
    ...
    //    url: '/Master/GetMaintenancePolicyFileUploadList', datatype: 'json'
    //});

    //$('#tblMaintenancePolicyUpload').jqGrid("setGridParam", { "postData": { stateCode: stateCode, agency: agencyCode} });
