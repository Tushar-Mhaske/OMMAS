...
$(document).ready(function () {
    ...
    $("#ddlDistricts").change(function () {
        FillInCascadeDropdown({ userType: $("#ddlDistricts").find(":selected").val() },
                   "#ddlBlocks", "/ExistingRoads/GetInactiveBlocksByDistrict?districtCode=" + $('#ddlDistricts option:selected').val());
        });
...
function LoadExistingRoads(MAST_BLOCK_CODE, MAST_ROAD_CAT_CODE) {
    ...
    jQuery("#tbExistingRoadsList").jqGrid({
        url: '/ExistingRoads/GetExistingRoadsListITNOForInactiveBlocks/',
        datatype: "json",
        mtype: "POST",
        ...
        colModel: [
                        ...
                        { name: 'Edit', width: 40, sortable: false, resize: false, align: "center", sortable: false, search: false /*hidden: ($("#RoleCode").val() == 22 ? false : true)*/, hidden: true }, /*Changes by SAMMED A. PATIL for mordviewuser*/
                        ...
                        {
                            name: 'Delete', width: 40, sortable: false, resize: false, align: "center", sortable: false, search: false, hidden: true
                        },
                       { name: 'Shift', width: 130, sortable: false, resize: false, formatter: FormatColumnShift, align: "center" }
...
function SearchExistingRoadList() {
    ...
    $('#tbExistingRoadsList').setGridParam({
        url: '/ExistingRoads/GetExistingRoadsListITNOForInactiveBlocks', datatype: 'json'
    });
...
function ShiftVillage1(parameter)
{
    ...
    $("#dvShiftVillage").load("/ExistingRoads/ShiftDetails/" + id, function () {
