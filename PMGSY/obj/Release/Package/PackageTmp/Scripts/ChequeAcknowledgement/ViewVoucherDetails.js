...
function LoadVoucherDetailsList()
{
    ...
    jQuery("#tbListVouchers").jqGrid({
        ...
        datatype: "json",
        mtype: "POST",
        postData: { BILL_MONTH: $("#BILL_MONTH option:selected").val(), BILL_YEAR: $('#BILL_YEAR option:selected').val(), DPIU: $("#DPIU option:selected").val() },
        colNames: ['Cheque/Epay Number', 'Cheque/Epay Date', 'Month-Year','Payee Name', 'Amount(In Rs.)', 'Finalize', 'Action'],
        colModel: [
...
function ViewVoucherDetails(billNumber)
{
    ...
    $("#divVoucherView").load('/ChequeAcknowledgement/GetChequeAckMasterList?' + $.param({ Month: $("#BILL_MONTH option:selected").val(), Year: $("#BILL_YEAR option:selected").val(), DPIU: $("#DPIU option:selected").val(), BillNo: billNumber }), function ()
    {
        $.unblockUI();
...
function AddNewVoucherDetails(AddMode) {
    ...
    $("#divVoucherView").html('');
    $("#divVoucherView").load('/ChequeAcknowledgement/GetChequeAckMasterList?' + $.param({ Month: $("#BILL_MONTH option:selected").val(), Year: $("#BILL_YEAR option:selected").val(), DPIU: $("#DPIU option:selected").val(), Mode: AddMode, AckUnackFlag: "A" }), function () {
...
function AddVoucherDetails(billNumber) {
    ...
    $("#divVoucherView").load('/ChequeAcknowledgement/GetChequeAckMasterList?' + $.param({ Month: $("#BILL_MONTH option:selected").val(), Year: $("#BILL_YEAR option:selected").val(), DPIU: $("#DPIU option:selected").val(), BillNo: billNumber,AckUnackFlag:"A" }), function () {
        $("#btnViewDetails").trigger('click');
        //$("#BILL_NO").attr('disabled', true);
        //$("#DPIU").attr('disabled', true);
        //$("#BILL_MONTH").attr('disabled', true);
...
function UnAcknowledgeVoucherDetails(billNumber) {
    ...
    $("#divVoucherView").load('/ChequeAcknowledgement/GetChequeAckMasterList?' + $.param({ Month: $("#BILL_MONTH option:selected").val(), Year: $("#BILL_YEAR option:selected").val(), DPIU: $("#DPIU option:selected").val(), BillNo: billNumber, AckUnackFlag: "U" }), function () {
        $("#btnViewDetails").trigger('click');      
        $.unblockUI();
    });
