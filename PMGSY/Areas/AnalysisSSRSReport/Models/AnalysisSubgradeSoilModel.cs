...
{
    public class AnalysisSubgradeSoilModel
    {

        public AnalysisSubgradeSoilModel()
        {
            ...
            Status = "%";
            CBRList = new List<SelectListItem>();
            CBRList.Add(new SelectListItem { Text = "All CBR", Value = "0" });
            CBRList.Add(new SelectListItem { Text = "less than 3", Value = "1" });
            CBRList.Add(new SelectListItem { Text = "greate than 3 and less than 4.99", Value = "2" });
            CBRList.Add(new SelectListItem { Text = "greate than 5 and less than 9.99", Value = "3" });
            CBRList.Add(new SelectListItem { Text = "greate than 10 ", Value = "4" });
            CBRList.Add(new SelectListItem { Text = "Undefined", Value = "5" });
            CBR = 0;
            RoadWise = false;
        ...
        [Display(Name = "CBR")]
        [Range(0, 5, ErrorMessage = "Please select CBR.")]
        public int CBR { get; set; }
        public List<SelectListItem> CBRList { get; set; }

        [Display(Name = "Roadwise")]
        public bool RoadWise { get; set; }

    }
    public class CompareValidationWithFromYearToYear : ValidationAttribute, IClientValidatable
    {
        private readonly string PropertyName;

        public CompareValidationWithFromYearToYear(string propertyName)
        {
