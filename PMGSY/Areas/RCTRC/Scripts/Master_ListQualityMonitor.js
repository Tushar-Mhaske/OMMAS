...
$(document).ready(function () {
    ...
    $.ajax({
        url: "/RCTRC/RCTRC/SearchQualityMonitor/",
        type: "GET",
        dataType: "html",
    ...
    $('#btnCreateNew').click(function (e) {
        ...
        if (!$("#dvQualityMonitorDetails").is(":visible")) {
            ...
            $("#dvQualityMonitorDetails").load("/RCTRC/RCTRC/AddOfficialDetails/");
    ...
    $('#btnSearchView').click(function (e) {
        ...
        if (!$("#dvSearchQualityMonitor").is(":visible")) {
            ...
            $('#dvSearchQualityMonitor').load('/RCTRC/RCTRC/SearchQualityMonitor/', function () {
    ...
    //        colModel: [
    //         { name: 'image', index: 'image', width: 190, sortable: false, align: "center", formatter: imageFormatter, search: false, editable: false , hidden :true},
    //         { name: 'ADMIN_QM_FNAME', index: 'ADMIN_QM_FNAME', height: 'auto', width: 120, align: "left", valign: "top", sortable: true, search: true },
    //         { name: 'MAST_STATE_CODE', index: 'MAST_STATE_CODE', height: 'auto', width: 140, align: "left", sortable: true, search: false, hidden: true },
    ...
    //         { name: 'PAN', index: 'PAN', height: 'auto', width: 120, align: "left", sortable: true, search: false, hidden: true },
    //         { name: 'ADMIN_QM_AADHAR_NO', index: 'ADMIN_QM_AADHAR_NO', height: 'auto', width: 120, align: "left", sortable: true, search: false, hidden: true },
    //         { name: 'ADMIN_QM_BIRTH_DATE', index: 'ADMIN_QM_BIRTH_DATE', height: 'auto', width: 100, align: "left", sortable: true, search: false, hidden: true },
    //         { name: 'ADMIN_QM_EMPANELLED_YEAR', index: 'ADMIN_QM_EMPANELLED_YEAR', height: 'auto', width: 110, align: "center", sortable: true, search: false, hidden: true },
    ...
    //         { name: 'ADMIN_QM_TYPE', index: 'ADMIN_QM_TYPE', width: 45, sortable: true, align: "center", search: false, hidden: true },
    ...
    //                    $("#tblBlockedQualityMonitorListDetails").jqGrid('setRowData', rows[i], false, { color: 'white', weightfont: 'bold', background: 'white' });
    //                }
    //            }
...
function LoadGrid() {
    ...
    $('#tblQualityMonitorListDetails').jqGrid({
        url: '/RCTRC/RCTRC/GetMasterQualityMonitorList/',
        datatype: 'json',
        mtype: "POST",                                                                                                                                                                                                     //, 'Block'        

        colNames: ['Image', 'Name', ' State', 'Designation', 'Address', 'Mobile', 'Email', 'PAN', ' Adhar', 'DoB', 'Upload PAN File', 'Empanelled Month-Year', 'Remarks', 'User Name', 'Upload Photo', 'SetColor'],
        colModel: [
         { name: 'image', index: 'image', width: 225, sortable: false, align: "center", formatter: imageFormatter, search: false, editable: false, hidden: true },//Added By Abhishek kamble To Show Image 27-June-2014
         { name: 'ADMIN_QM_FNAME', index: 'ADMIN_QM_FNAME', height: 'auto', width: 120, align: "left", valign: "top", sortable: true, search: true },
         ...
         { name: 'PAN', index: 'PAN', height: 'auto', width: 70, align: "left", sortable: true, search: false, hidden: true },
         { name: 'ADMIN_QM_AADHAR_NO', index: 'ADMIN_QM_AADHAR_NO', height: 'auto', width: 70, align: "left", sortable: true, search: false, hidden: true },
         { name: 'ADMIN_QM_BIRTH_DATE', index: 'ADMIN_QM_BIRTH_DATE', height: 'auto', width: 70, align: "left", sortable: true, search: false, hidden: true },
         { name: 'PANFile', index: 'PANFile', height: 'auto', width: 70, align: "left", sortable: true, search: false, hidden: true },
       //  { name: 'ADMIN_QM_EMPANELLED', index: 'ADMIN_QM_EMPANELLED', height: 'auto', width: 60, align: "center", sortable: false, search: false },
         { name: 'ADMIN_QM_EMPANELLED_YEAR', index: 'ADMIN_QM_EMPANELLED_YEAR', height: 'auto', width: 70, align: "center", sortable: true, search: false, hidden: true },
         { name: 'Remarks', index: 'Remarks', height: 'auto', width: 100, align: "left", sortable: true, search: false , hidden:true},
       //  { name: 'ADMIN_QM_TYPE', index: 'ADMIN_QM_TYPE', width: 45, sortable: true, align: "center", search: false },
         ...
         { name: 'Upload', index: 'Upload', width: 40, sortable: false, align: "center", hidden: false, search: false, hidden: true },
        // { name: 'a', width: 50, sortable: false, resize: false, formatter: FormatColumn, align: "center", sortable: false, search: false, hidden: true },//Added by DEENDAYAL on 20JUNE2017 Allow SQC to modify SQM details
        { name: 'SetColor', width: 10, sortable: false, resize: false, hidden: true, search: false },
...
function AddSQMUserLoginDetails(id) {
    ...
    $.ajax({
        url: "/RCTRC/AddSQMUserLoginQualityMonitorDetails/" + id,
        type: "GET",
        //async: false,
        //dataType: "html",
        //catche: false,
