...
function ShowDetails(id) {
    ...
    $('#accordion').show('fold', function () {
        blockPage();
        $("#tbFBDetailsForm").load('/FeedbackDetails/ViewFBDetailsNew/' + id, function () {
        ...
        beforeActivate: function (event, ui) {
            ...
            switch (ui.newTab.index()) {
                case 0:
                    ...
                    $.ajax({
                        url: '/FeedbackDetails/ViewFBDetailsNew/' + $("#hdnFeedId").val(),
                        async: false,
                        cache: false,
                        type: "GET",
                        dataType: "html",
                ...
                case 1:
                    ...
                    $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif"/>' });
                    $.ajax({
                        url: '/FeedbackDetails/DisplayFBFilesNew/' + $("#hdnFeedId").val(),
                        async: false,
                        cache: false,
                        type: "GET",
                        dataType: "html",
                ...
                case 3:
                    ...
                    $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif"/>' });
                    $.ajax({
                        url: '/FeedbackDetails/FBRepStatusNew/' + $("#hdnFeedId").val(),
                        async: false,
                        cache: false,
                        type: "GET",
                        dataType: "html",
