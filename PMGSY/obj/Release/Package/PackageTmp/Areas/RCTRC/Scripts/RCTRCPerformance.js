 ...
 //   LoadInspDetailsList();
    ...
    $("#btnSave").click(function (e) {
        ...
        if ($("#frmAddCdWorks").valid()) {
            ...
            $.ajax({
                type: 'POST',
                url: '/RCTRC/RCTRC/AddPerformance/',
                async: false,
...
function LoadInspDetailsList(PersonCode) {
    ...
    jQuery("#tbCDWorksList").jqGrid({
        url: '/RCTRC/RCTRC/GetPerformanceList',
        datatype: "json",
        mtype: "POST",
        postData: { postdataPersonID: personIDSwitch },
       // postData: { RSACode: RSACode },
        colNames: ['Person Name', 'Cause of perceived discrepancies in Performance', 'Status'],
        colModel: [
                            { name: 'Contact_Person', index: 'Contact_Person', height: 'auto', width: 400, align: "left", search: false },
                            { name: 'Performance_Cause', index: 'Performance_Cause', height: 'auto', width: 400, align: "left", search: false },
                            { name: 'Status_Cause', index: 'Status_Cause', height: 'auto', width: 400, align: "center", search: false },
        ...
        sortorder: "asc",
        caption: "&nbsp;&nbsp;List of discrepancies in Performance",
        height: 'auto',
        hidegrid: true,
        rownumbers: true,
