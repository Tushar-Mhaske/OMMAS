...
this.imagePreview = function () {
    ...
    /* END CONFIG */
    var callback = function (event, param, x, y) {
       
        $("#imgDiv")
            .css({
                "bottom": ($("#dvFiles").offset().top + 90) + "px",
                "left": ($("#dvFiles").offset().left - 60) + "px",
                'display': 'block',
            });

        $img
            .css({
                "top": ($("#dvFiles").offset().top + 90) + "px",
                "left": ($("#dvFiles").offset().left - 60) + "px",
                'display': 'block',
            });
    ...
    $("a.preview").hover(function (e) {
        ...
        Mx = (mouseX - ($(this).offset().left)); // * 2;//600
        My = (mouseY - ($(this).offset().top) + 80); //600;
        ...
        $("#imgDiv").html("<p id='preview'><img  style='height: 495px; width: 500px;' src='" + lnkHref + "' alt='Image Not Available' />" + c + "</p>");

        //alert($(this).offset().top);
        $("#imgDiv")
        .css({
            "top": ($(this).offset().top - 510) + "px",
