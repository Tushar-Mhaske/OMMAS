...
$(document).ready(function () {
    ...
    $("#ddlRoadCategory").change(function (e) {
        ...
        FillInCascadeDropdown({ userType: $("#ddlRoadCategory").find(":selected").val() },
                   "#ddlRoadCode", "/CoreNetwork/GetRoadNameByRoadCode?roadName=" + $('#ddlRoadCategory option:selected').val() + "&blockName=" + $("#MAST_BLOCK_CODE").val());
    ...
    $("#btnSave").click(function () {
        ...
        //setTimeout(function () {
        if ($("#frmAddRCPLWE").valid()) {
            //if (true) {
            $.ajax({
                type: 'POST',
                url: '/CoreNetwork/AddRCPLWE/',
                async: false,
                data: $("#frmAddRCPLWE").serialize(),
                beforeSend: function () {
                    blockPage();
                },
                success: function (data) {
