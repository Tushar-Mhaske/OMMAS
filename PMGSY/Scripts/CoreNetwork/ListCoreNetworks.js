...
$(document).ready(function () {
    ...
    $("#btnAddCoreNetwork").click(function () {
        ...
        $('#accordion').show('fold', function () {
            ...
            $("#divAddForm").load("/CoreNetwork/AddEditCoreNetworks/" + $('#ddlStates').val() + "$" + $('#ddlDistricts').val() + "$" + blockCode, function () {
                $.validator.unobtrusive.parse($('#frmAddCoreNetwork'));
                unblockPage();
            });
...
function LoadNetworkGrid() {
    ...
    jQuery("#networkCategory").jqGrid({
        url: '/CoreNetwork/GetCoreNetWorksList',
        datatype: "json",
        mtype: "POST",
        ...
        colModel: [
                            ...
                            { name: 'c', width: 50, sortable: false, resize: false, align: "center", search: false, hidden: ($("#RoleCode").val() == 22 ? false : true) },
...
function editNetworkData(urlparameter) {
    ...
    $('#accordion').show('fold', function () {
        blockPage();
        $("#divAddForm").load('/CoreNetWork/EditCoreNetworks/' + urlparameter, function (data) {
            unblockPage();
...
function editHabitationDetails(urlparameter) {
    ...
    $('#accordion').show('fold', function () {
        blockPage();
        $("#divAddForm").load('/CoreNetWork/ListHabitations/' + urlparameter, function (data) {
            unblockPage();
            if (data.success == false)
            {
                alert("Error occurred while processing the request.");
...
function detailsCoreNetwork(urlparameter) {
    ...
    $('#accordion').show('fold', function () {
        blockPage();
        $("#divAddForm").load('/CoreNetWork/DetailsCoreNetwork/' + urlparameter, function (data) {
            unblockPage();
            if (data.success == false) {
                alert("Error occurred while processing the request.");
            }
...
function MapOtherCandidateRoad(urlparameter) {
    ...
    $('#accordion').show('fold', function () {
        blockPage();
        $("#divAddForm").load('/CoreNetWork/MapOtherCandidateRoadView/' + urlparameter, function (data) {
            unblockPage();
            if (data.success == false) {
                alert("Error occurred while processing the request.");
            }
