...
function LoadExecutionGrid() {
    ...
    jQuery("#tbExecutionList").jqGrid({
        ...
        colNames: ['Block', 'Year', 'Batch', 'Package No.', 'Road Name', 'Road/LSB Cost (In Lacs)', 'Road Length(in Kms)/LSB Length(int Mtrs)', 'Maintenance Cost(in Lacs)', 'Convergence of Technology', 'CDWorks', 'Action', 'Habitation', 'Technology', 'Financial', 'Images', 'Remarks', 'Executing Officer', 'Road Safety'],
        colModel: [
...
//returns the view of Additional Road Details
function AddAdditionalRoadDetails(urlparameter) {

    $("#accordion div").html("");
    $("#accordion h3").html(
            "<a href='#' style= 'font-size:.9em;' >Add Additional Road Details</a>" +
    ...
    $('#accordion').show('fold', function () {
        //alert(urlparameter);
        blockPage();
        $("#divAddExecution").load('/Execution/AdditionalRoadDetails?urlparameter=' + urlparameter, function () {
