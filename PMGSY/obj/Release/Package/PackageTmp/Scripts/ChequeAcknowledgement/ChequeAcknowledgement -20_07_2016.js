...
jQuery.validator.addMethod("DateInMonthYear", function (value, element) {
    ...
    //alert("BILL_MONTH_VOUCHER: " + $("#BILL_MONTH_VOUCHER").val() + " Month: " + month);
    //alert("BILL_YEAR_VOUCHER: " + $("#BILL_YEAR_VOUCHER").val()+"Year :" + year);
...
$(document).ready(function () {
    ...
    //Commented By Abhishek kamble 27-Aug-2014 to dont show date picker
...
function loadGrid(month, year, dpiu) {
    ...
    $grid.jqGrid({
        ...
        onSelectAll: function (aRowids, status) {
            ...
            if (status) {
                ...
                for (var i = 0; i < aRowids.length; i++) {
                    ...
                    //Disable cheque box added By Abhishek kamble 26-Aug-2014 start                    
                    if ($("#AckUnackFlag").val() == "A") {
                        amtTotal = parseFloat(amtTotal) + parseFloat(rowData.ChequeAmount);
        ...
        loadComplete: function (xhr, st, err) {
            ...
            {//else added BY Abhishek kamble to set BILL ID 16-July-2014
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Success != "") {
                ...
                //if finalized disable voucher number and date
                if (details[2] == "Y") {
