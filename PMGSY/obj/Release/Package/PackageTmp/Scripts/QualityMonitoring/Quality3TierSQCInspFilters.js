...
$(document).ready(function () {
    ...
    InspectionListGrid($("#stateCode3TierSQCInsp").val(), $("#monitorCode3TierSQCInsp").val(), $("#frmMonth3TierSQCInsp").val(), $("#frmYear3TierSQCInsp").val(), $("#toMonth3TierSQCInsp").val(), $("#toYear3TierSQCInsp").val());
