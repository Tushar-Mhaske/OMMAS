...
function LoadProposalsForUpdate(IMS_YEAR, MAST_DISTRICT_ID, MAST_BLOCK_CODE, IMS_BATCH, IMS_STREAM, IMS_PROPOSAL_TYPE, IMS_PROPOSAL_STATUS, IMS_UPGRADE_CONNECT) {
    ...
    jQuery("#tbUpdateProposalList").jqGrid({
        url: '/Proposal/GetProposalsForUpdate',
        datatype: "json",
        mtype: "POST",
        ...
        postData: { "IMS_YEAR": IMS_YEAR, "MAST_DISTRICT_ID": MAST_DISTRICT_ID, "MAST_BLOCK_ID": MAST_BLOCK_CODE, "IMS_BATCH": IMS_BATCH, "IMS_STREAM": IMS_STREAM, "IMS_PROPOSAL_TYPE": IMS_PROPOSAL_TYPE, "IMS_PROPOSAL_STATUS": IMS_PROPOSAL_STATUS, "IMS_UPGRADE_CONNECT": IMS_UPGRADE_CONNECT },
...
function EditDetails(IMS_PR_ROAD_CODE) {
    ...
    $('#accordion').show('fold', function () {
        ...
        $("#divProposalUpdateForm").load("/Proposal/UpdateProposalDetails/" + IMS_PR_ROAD_CODE, function () {
