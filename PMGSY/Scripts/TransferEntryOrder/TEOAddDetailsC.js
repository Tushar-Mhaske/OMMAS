...
$(document).ready(function () {
                ...
                success: function (data) {
                    ...
                    if (data.CON_REQ == "Y") {
                        if ($("#ddlDistrictC").css('display') != "none" && $("#ddlDistrictC").val() != 0)
                        {
                            ...
                            if (parentTxnId == 3100) {
                                FillInCascadeDropdown(null, '#ddlHeadContractorC', "/TEO/PopulateContractorWithNoOption/" + $("#ddlDistrictC").val());
                        ...
                        else
                        {
                            ...
                            if (parentTxnId == 3100) {
                                FillInCascadeDropdown(null, '#ddlHeadContractorC', "/TEO/PopulateContractorWithNoOption/");
                ...
                success: function (data) {
                    if (aggC == "Y") {
                        if ($("#ddlDistrictC").val() == 0) {
                            ...
                            if (parentTxnId == 3100 && $("#ddlHeadContractorC option:selected").val() == "-1") {
                                FillInCascadeDropdown(null, '#ddlHeadAgreementC', "/TEO/PopulateAgreementWithNoOption/" + $("#ddlDistrictC").val() + "$" + $("#ddlHeadContractorC").val());//Added on 03-10-2022

                            } else {
                                FillInCascadeDropdown(null, '#ddlHeadAgreementC', "/TEO/PopulateAgreement/" + $("#ddlDistrictC").val() + "$" + $("#ddlHeadContractorC").val());//Commented on 03-10-2022
    ...
    $("#ddlHeadAgreementC").change(function () {
        ...
        if (roadC == "Y")
        {
            ...
            if (parentTxnId == 3100 && $("#ddlHeadAgreementC option:selected").val() == "-1") {

                FillInCascadeDropdown(null, '#ddlHeadRoadC', "/TEO/PopulateRoadWithNoOption/" + $("#ddlHeadAgreementC option:selected").val() + "$" + $("#ddlHeadPackageC option:selected").val() + "$0$" + $("#ddlHeadContractorC option:selected").val() + "?" + $.param({ AGREEMENT_NUMBER: $("#ddlHeadAgreementC option:selected").text() }));
