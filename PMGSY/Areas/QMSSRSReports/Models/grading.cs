...
namespace PMGSY.Areas.QMSSRSReports.Models
{
    public class grading
    {
       ...
       // [DateValidationVST("FromYear", "FromMonth", "ToMonth", ErrorMessage = "To Year must be greater than or equal to From Year.")]
        ...
        [Display(Name = "NQM Inspection(Road Status)")]
        public char nqmRoadStatus { get; set; }
        public List<SelectListItem> nqmRoadList { get; set; }


        [Display(Name = "SQM Inspection(Road Status)")]
        public char sqmRoadStatus { get; set; }
        public List<SelectListItem> sqmRoadList { get; set; }


        [Display(Name = "NQM Overall Grade")]
        public int nqmoverall { get; set; }
        public List<SelectListItem> nqmoverallList { get; set; }


        [Display(Name = "SQM Overall Grade")]
        public int sqmoverall { get; set; }
        public List<SelectListItem> sqmoverallList { get; set; }
