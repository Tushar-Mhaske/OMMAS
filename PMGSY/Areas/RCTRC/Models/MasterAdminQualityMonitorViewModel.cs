    ...
    //    public string ADMIN_QM_PAN { get; set; }
     ...
     //   [Range(1, 12, ErrorMessage = "Select valid Month.")]//Added by deendayal on 21/06/2017
        ...
        public SelectList QmDesignations
        {
            get
            {
                List<RCTRC_MASTER_DESIGNATION> designationList = new List<RCTRC_MASTER_DESIGNATION>();
                IRctrcDAL objDAL = new RctrcDAL();

                designationList = objDAL.GetAllQmDesignation();
                designationList.Insert(0, new RCTRC_MASTER_DESIGNATION() { MAST_DESIG_CODE = 0, MAST_DESIG_NAME = "--Select--" });
