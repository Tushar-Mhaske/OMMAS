...
$(document).ready(function () {
    ...
    $("#spnDurableAssets").click(function () {
        $("#spnDurableAssets").toggleClass("ui-icon ui-icon-circle-triangle-n").toggleClass("ui-icon ui-icon-circle-triangle-s");
...
function ShowReport(levelId) {
   ...
   // var StateSrrdaDpiu;
    ...
    if (year == 0) {        
        ...
        var data = { month: month, year: year, ndcode: ndcode, rlevel: reportLevel, allpiu: allpiu, duration: Duration };
        ValidateForm(data);
    }
}
...
function loadCurrentAssetReport(data) {
    ...
    $.ajax({
        url: '/AccountReports/Account/DurableAssetReport/',
        type: 'POST',
        catche: false,
        async: false,
        data: data,
