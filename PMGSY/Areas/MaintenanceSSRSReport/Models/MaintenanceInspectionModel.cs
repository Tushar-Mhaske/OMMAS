...
{
    public class MaintenanceInspectionModel
   
    {

        public MaintenanceInspectionModel()
        {
            ...
            TypeList.Add(new SelectListItem { Text = "Pending", Value = "P" });
            TypeList.Add(new SelectListItem { Text = "Completed", Value = "C" });
            Type = "%";
