$(document).ready(function () {
    ...
    GetSurfaceListPMGSY3($("#MAST_ER_ROAD_CODE").val());
    ...
    $('#btnSave').click(function (evt) {
        ...
        if ($('#frmSurfaceType').valid()) {
            if (validateForm() == true) {                            
                $.ajax({
                    url: "/ExistingRoads/AddSurfaceDetailsPMGSY3/",
                    type: "POST",
                    cache: false,
    ...
    $('#btnUpdate').click(function (evt) {
        ...
        if ($('#frmSurfaceType').valid()) {
            $.ajax({
                url: "/ExistingRoads/EditSurfaceDetailsPMGSY3/",
                type: "POST",
                cache: false,
                data: $("#frmSurfaceType").serialize(),
                beforeSend: function () {
...
function DisplaySurfaceStartChainage(MAST_ER_ROAD_CODE) {
    ...
    $.ajax({
        url: '/ExistingRoads/SurfaceStartChainageUpdatePMGSY3/',
        type: 'POST',
        beforeSend: function () {
            blockPage();
        },
