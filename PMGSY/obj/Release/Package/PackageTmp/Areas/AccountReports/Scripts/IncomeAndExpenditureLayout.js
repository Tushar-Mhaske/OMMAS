    ...
    $("#btnView").click(function () {
        ...
        if ($("#rdbState").is(":checked") && $("#rdbAnnual").is(":checked")) {
            if ($("#Piu option:selected").val() == 0) {
                data = { month: 1, Year: $("#Year option:selected").val(), ndcode: $("#Agency option:selected").val(), rlevel: 4, AllPiu: 0, duration: 1, NodalAgency: $("#Agency option:selected").text() };
            }
            else {
                data = { month: 1, Year: $("#Year option:selected").val(), ndcode: $("#Agency option:selected").val(), rlevel: 4, AllPiu: $("#Piu option:selected").val(), duration: 1, NodalAgency: $("#Agency option:selected").text() };
            }
            ValidateForm(data);
        }
        ...
        if ($("#rdbState").is(":checked") && $("#rdbMonth").is(":checked")) {
            if ($("#Piu option:selected").val() == 0) {
                data = { Month: $("#Month option:selected").val(), Year: $("#Year option:selected").val(), ndCode: $("#Agency option:selected").val(), rlevel: 4, allPiu: 0, duration: 2, NodalAgency: $("#Agency option:selected").text() };
            }
            else {
                data = { Month: $("#Month option:selected").val(), Year: $("#Year option:selected").val(), ndCode: $('#Agency option:selected').val(), rlevel: 4, allPiu: $("#Piu option:selected").val(), duration: 2, NodalAgency: $("#Agency option:selected").text() };
            }
            ValidateForm(data);
        }
        ...
        if ($("#rdbSrrda").is(":checked") && $("#rdbAnnual").is(":checked")) {
            data = { month: 1, Year: $("#Year option:selected").val(), ndcode: $("#Agency option:selected").val(), rlevel: 1, AllPiu: 0, duration: 1, NodalAgency: $("#Agency option:selected").text() };
            ValidateForm(data);
        }
        // selection- state & Monthly
        if ($("#rdbSrrda").is(":checked") && $("#rdbMonth").is(":checked")) {
            data = { Month: $("#Month option:selected").val(), Year: $("#Year option:selected").val(), ndCode: $("#Agency option:selected").val(), rlevel: 1, allPiu: 0, duration: 2, NodalAgency: $("#Agency option:selected").text() };
            ValidateForm(data);
        }
        // selection- DPIU & Annual
        if ($("#rdbPiu").is(":checked") && $("#rdbAnnual").is(":checked")) {
            if ($("#Piu option:selected").val() == 0) {
                data = { month: 1, Year: $("#Year option:selected").val(), ndcode: $("#Agency option:selected").val(), rlevel: 2, AllPiu: 1, duration: 1, DPIU: $("#Piu option:selected").text(), NodalAgency: $("#Agency option:selected").text() };
            }
            else {
                data = { month: 1, Year: $("#Year option:selected").val(), ndcode: $("#Piu option:selected").val(), rlevel: 2, AllPiu: 0, duration: 1, DPIU: $("#Piu option:selected").text(), NodalAgency: $("#Agency option:selected").text() };
            }
            ValidateForm(data);
        }
        ...
        if ($("#rdbPiu").is(":checked") && $("#rdbMonth").is(":checked")) {
            if ($("#Piu option:selected").val() == 0) {
                data = { month: $("#Month option:selected").val(), Year: $("#Year option:selected").val(), ndcode: $("#Agency option:selected").val(), rlevel: 2, AllPiu: 1, duration: 2, DPIU: $("#Piu option:selected").text(), NodalAgency: $("#Agency option:selected").text() };
            }
            else {
                data = { month: $("#Month option:selected").val(), Year: $("#Year option:selected").val(), ndcode: $("#Piu option:selected").val(), rlevel: 2, AllPiu: 0, duration: 2, DPIU: $("#Piu option:selected").text(), NodalAgency: $("#Agency option:selected").text() };
            }
            ValidateForm(data);
        }
...
function ValidateForm1(param) {
    $.ajax({
        url: "/AccountReports/Account/ListIncomeAndExpenditureReport/",
        type: "POST",
        data: param,
        success: function (data) {
            $("#dvIncomeAndExpenditure").html(data);
            //if (data.success == false) {
            //    $("#divError").html('<strong>Alert : </strong>' + data.message);
            //    $("#divError").show("slow");
            //    return false;
