...
function SearchDetails() {
   // alert("s2");
    ...
    $('#tblQualityMonitorListDetails').setGridParam({
        url: '/Master/GetMasterQualityMonitorList', datatype: 'json'
    });

    $('#tblQualityMonitorListDetails').jqGrid("setGridParam", { "postData": { QmTypeName: $('#ddlSearchQmTypes option:selected').val(), stateCode: $('#ddlSearchStates option:selected').val(), districtCode: $('#ddlSearchDistrict option:selected').val(), isEmpanelled: $('#ddlSearchEmpanelled option:selected').val(), firstName: $('#gs_ADMIN_QM_FNAME').val() } });
