...
function LoadRenewalCompletedRoads() {

    jQuery("#tbProposedRoadList").jqGrid({
        url: '/MaintenanceAgreement/GetCompletedRoadListForRenewalAgreements',
        datatype: "local",
        mtype: "POST",
        colNames: ['Block', 'Year', 'Batch', 'Old Package','New Package', 'Work Name', 'Road Length', 'Funding Agency', 'Sanctioned Cost', 'Maintenance Cost', 'View'],
        colModel: [
                            ...
                            { name: 'NewPackage', index: 'NewPackage', width: 10, sortable: true, align: "center" },
        ...
        caption: "Proposed Work List for Renewal Maintenance Agreement",
        height: 'auto',
        autowidth: true,
        rownumbers: true,
        hidegrid: true,
...
function ViewRenewalMaintenanceAgreement(parameter) {

    $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif"/>' });
    $.ajax({
        url: "/MaintenanceAgreement/AddRenewalAgreementAgainstRoad/" + parameter,
        type: "GET",
        async: false,
        cache: false,
