...
$(document).ready(function () {
    ...
    $("#ddlRoadCategory").change(function (e) {
        ...
        FillInCascadeDropdown({ userType: $("#ddlRoadCategory").find(":selected").val() },
            "#ddlRoadCode", "/CoreNetwork/GetRoadNameByRoadCodeVVP?roadName=" + $('#ddlRoadCategory option:selected').val() + "&blockName=" + $("#MAST_BLOCK_CODE").val());
    ...
    $("#btnSave").click(function () {
        ...
        if ($("#frmAddCoreNetwork").valid()) {
            ...
            $.ajax({
                type: 'POST',
                url: '/CoreNetwork/AddCoreNetworksVVP/',
                async: false,
    ...
    $("#btnUpdate").click(function () {
        ...
        if ($("#frmAddCoreNetwork").valid()) {
            ...
            $.ajax({
                type: 'POST',
                url: '/CoreNetwork/EditCoreNetworksVVP/',
                async: false,
                data: $("#frmAddCoreNetwork").serialize(),
                success: function (data) {
                    if (data.success === undefined) {
