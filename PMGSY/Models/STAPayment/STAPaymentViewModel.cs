...
{
    public class STAPaymentViewModel
    {
        [Display(Name = "State")]
        ...
        public string STA_SERVICE_TAX_NO { get; set; }
    ...
    public class STAPaymentTotalModel
    {
    ...
    public class STAPaymentTotalViewModel
    {
    ...
    public class STAPayemntInvoiceModel
    {
