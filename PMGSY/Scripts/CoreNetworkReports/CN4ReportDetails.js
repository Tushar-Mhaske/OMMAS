$(function () {
    ...
    //}).trigger('resize');
        ...
        if ($("#hdnLevelId").val() == 6) //mord
        {
            ...
            CN4StateReportListing(route,roadCategory);
        }
        else if ($("#hdnLevelId").val() == 4) //state
        {
          
            CN4DistrictReportListing($("#MAST_STATE_CODE").val(), $("#STATE_NAME").val(),route, roadCategory);
        }
        else if ($("#hdnLevelId").val() == 5) //District
        {
          
            CN4BlockReportListing($("#MAST_DISTRICT_CODE").val(), $("#MAST_STATE_CODE").val(), $("#DISTRICT_NAME").val(), route, roadCategory);
        }
   
});

/*       STATE REPORT LISTING       */
function CN4StateReportListing(route,roadCategory) {
    $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif"/>' });
    $("#CN4StateReportTable").jqGrid('GridUnload');
    $("#CN4DistrictReportTable").jqGrid('GridUnload');
    $("#CN4BlockReportTable").jqGrid('GridUnload');
    $("#CN4FinalReportTable").jqGrid('GridUnload');

    $("#CN4StateReportTable").jqGrid({
        url: '/CoreNetworkReports/CN4StateReportListing',
        datatype: 'json',
        mtype: 'POST',
        ...
        loadComplete: function () {
            ...
            $('#CN4StateReportTable_rn').html('Sr.<br/>No.');
            $.unblockUI();
        },
        gridComplete: function () {
            var ids = jQuery("#CN4StateReportTable").jqGrid('getDataIDs');
            var previousId = 0;
            for (var i = 0; i < ids.length; i++) {
                var rowId = ids[i];
                var rowData = jQuery('#CN4StateReportTable').jqGrid('getRowData', rowId);
                ...
                $("#CN4StateReportTable").jqGrid('setCell', rowId, 'TotalRoadLength', parseFloat(newTotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4StateReportTable").jqGrid('setCell', rowId, 'NH_TotalRoadLength', parseFloat(newNH_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4StateReportTable").jqGrid('setCell', rowId, 'SH_TotalRoadLength', parseFloat(newSH_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4StateReportTable").jqGrid('setCell', rowId, 'MDR_TotalRoadLength', parseFloat(newMDR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4StateReportTable").jqGrid('setCell', rowId, 'LR_TotalRoadLength', parseFloat(newLR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4StateReportTable").jqGrid('setCell', rowId, 'TR_TotalRoadLength', parseFloat(newTR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
    ...
    $("#CN4StateReportTable").jqGrid('setGroupHeaders', {
...
function CN4DistrictReportListing(stateCode, stateName,route, roadCategory) {
    $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif"/>' });

    $("#CN4StateReportTable").jqGrid('setSelection', stateCode);
    $("#CN4StateReportTable").jqGrid('setGridState', 'hidden');
    $("#CN4DistrictReportTable").jqGrid('GridUnload');
    $("#CN4BlockReportTable").jqGrid('GridUnload');
    $("#CN4FinalReportTable").jqGrid('GridUnload');

    $("#CN4DistrictReportTable").jqGrid({
        url: '/CoreNetworkReports/CN4DistrictReportListing',
        datatype: 'json',
        mtype: 'POST',
        ...
        loadComplete: function () {
            ...
            $(this).jqGrid('footerData', 'set', { TR_TRACK_LEN: TR_TRACK_LEN_T }, true);
            $(this).jqGrid('footerData', 'set', { TR_TotalRoadLength: TR_TotalRoadLength_T }, true);
            $('#CN4DistrictReportTable_rn').html('Sr.<br/>No.');
            $.unblockUI();
        },
        gridComplete: function () {
            var ids = jQuery("#CN4DistrictReportTable").jqGrid('getDataIDs');
            var previousId = 0;
            for (var i = 0; i < ids.length; i++) {
                var rowId = ids[i];
                var rowData = jQuery('#CN4DistrictReportTable').jqGrid('getRowData', rowId);
                var newTotalRoadLength = parseFloat(rowData.BT_LEN) + parseFloat(rowData.WBM_LEN) + parseFloat(rowData.GRAVEL_LEN) + parseFloat(rowData.TRACK_LEN);
                var newNH_TotalRoadLength = parseFloat(rowData.NH_BT_LEN) + parseFloat(rowData.NH_WBM_LEN);
                var newSH_TotalRoadLength = parseFloat(rowData.SH_BT_LEN) + parseFloat(rowData.SH_WBM_LEN);
                var newMDR_TotalRoadLength = parseFloat(rowData.MDR_BT_LEN) + parseFloat(rowData.MDR_WBM_LEN) + parseFloat(rowData.MDR_GRAVEL_LEN) + parseFloat(rowData.MDR_TRACK_LEN);
                ...
                $("#CN4DistrictReportTable").jqGrid('setCell', rowId, 'TotalRoadLength', parseFloat(newTotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4DistrictReportTable").jqGrid('setCell', rowId, 'NH_TotalRoadLength', parseFloat(newNH_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4DistrictReportTable").jqGrid('setCell', rowId, 'SH_TotalRoadLength', parseFloat(newSH_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4DistrictReportTable").jqGrid('setCell', rowId, 'MDR_TotalRoadLength', parseFloat(newMDR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4DistrictReportTable").jqGrid('setCell', rowId, 'LR_TotalRoadLength', parseFloat(newLR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4DistrictReportTable").jqGrid('setCell', rowId, 'TR_TotalRoadLength', parseFloat(newTR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
    ...
    $("#CN4DistrictReportTable").jqGrid('setGroupHeaders', {
        useColSpanStyle: false,
        groupHeaders: [
            { startColumnName: 'BT_LEN', numberOfColumns: 5, titleText: '<em>Total Road Length (Kms)</em>' },
            { startColumnName: 'NH_BT_LEN', numberOfColumns: 3, titleText: '<em>National Highway (Kms)</em>' },
...
function CN4BlockReportListing(districtCode, stateCode, districtName,route, roadCategory) {
    ...
    $("#CN4DistrictReportTable").jqGrid('setSelection', districtCode);
    $("#CN4DistrictReportTable").jqGrid('setGridState', 'hidden');
    $("#CN4StateReportTable").jqGrid('setGridState', 'hidden');

    $("#CN4BlockReportTable").jqGrid('GridUnload');
    $("#CN4FinalReportTable").jqGrid('GridUnload');

    $("#CN4BlockReportTable").jqGrid({
        url: '/CoreNetworkReports/CN4BlockReportListing',
        datatype: 'json',
        mtype: 'POST',
        ...
        colModel: [
            ...
            { name: 'MDR_TRACK_LEN', width: 120, align: 'right', height: 'auto', sortable: false, formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 3, defaulValue: "N.A" } },
            { name: 'MDR_TotalRoadLength', width: 120, align: 'right', height: 'auto', sortable: false, formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 3, defaulValue: "N.A" } },
            { name: 'LR_BT_LEN', width: 120, align: 'right', height: 'auto', formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",",decimalPlaces: 3, defaulValue: "N.A" } },
            { name: 'LR_WBM_LEN', width: 120, align: 'right', height: 'auto', sortable: false, formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 3, defaulValue: "N.A" } },
            { name: 'LR_GRAVEL_LEN', width: 120, align: 'right', height: 'auto', sortable: false, formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 3, defaulValue: "N.A" } },
            { name: 'LR_TRACK_LEN', width: 120, align: 'right', height: 'auto', sortable: false, formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 3, defaulValue: "N.A" } },
            { name: 'LR_TotalRoadLength', width: 120, align: 'right', height: 'auto', sortable: false, formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 3, defaulValue: "N.A" } },
        ...
        loadComplete: function () {
            ...
            $(this).jqGrid('footerData', 'set', { TR_TRACK_LEN: TR_TRACK_LEN_T }, true);
            $(this).jqGrid('footerData', 'set', { TR_TotalRoadLength: TR_TotalRoadLength_T }, true);
            $('#CN4BlockReportTable_rn').html('Sr.<br/>No.');
            $.unblockUI();
        },
        gridComplete: function () {
            var ids = jQuery("#CN4BlockReportTable").jqGrid('getDataIDs');
            var previousId = 0;
            for (var i = 0; i < ids.length; i++) {
                var rowId = ids[i];
                var rowData = jQuery('#CN4BlockReportTable').jqGrid('getRowData', rowId);
                var newTotalRoadLength = parseFloat(rowData.BT_LEN) + parseFloat(rowData.WBM_LEN) + parseFloat(rowData.GRAVEL_LEN) + parseFloat(rowData.TRACK_LEN);
                var newNH_TotalRoadLength = parseFloat(rowData.NH_BT_LEN) + parseFloat(rowData.NH_WBM_LEN);
                var newSH_TotalRoadLength = parseFloat(rowData.SH_BT_LEN) + parseFloat(rowData.SH_WBM_LEN);
                var newMDR_TotalRoadLength = parseFloat(rowData.MDR_BT_LEN) + parseFloat(rowData.MDR_WBM_LEN) + parseFloat(rowData.MDR_GRAVEL_LEN) + parseFloat(rowData.MDR_TRACK_LEN);
                ...
                $("#CN4BlockReportTable").jqGrid('setCell', rowId, 'TotalRoadLength', parseFloat(newTotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4BlockReportTable").jqGrid('setCell', rowId, 'NH_TotalRoadLength', parseFloat(newNH_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4BlockReportTable").jqGrid('setCell', rowId, 'SH_TotalRoadLength', parseFloat(newSH_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4BlockReportTable").jqGrid('setCell', rowId, 'MDR_TotalRoadLength', parseFloat(newMDR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4BlockReportTable").jqGrid('setCell', rowId, 'LR_TotalRoadLength', parseFloat(newLR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
                $("#CN4BlockReportTable").jqGrid('setCell', rowId, 'TR_TotalRoadLength', parseFloat(newTR_TotalRoadLength).toFixed(3).toString().toLocaleString("en-IN"));
    ...
    $("#CN4BlockReportTable").jqGrid('setGroupHeaders', {
        useColSpanStyle: false,
        groupHeaders: [
          { startColumnName: 'BT_LEN', numberOfColumns: 5, titleText: '<em>Total Road Length (Kms)</em>' },
          { startColumnName: 'NH_BT_LEN', numberOfColumns: 3, titleText: '<em>National Highway (Kms)</em>' },
...
function CN4FinalReportListing(blockCode, districtCode, stateCode, blockName, route, roadCategory) {
    $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif"/>' });

    $("#CN4BlockReportTable").jqGrid('setGridState', 'hidden');
    $("#CN4DistrictReportTable").jqGrid('setGridState', 'hidden');
    $("#CN4StateReportTable").jqGrid('setGridState', 'hidden');
    $("#CN4BlockReportTable").jqGrid('setSelection', stateCode);
    $("#CN4FinalReportTable").jqGrid('GridUnload');

    $("#CN4FinalReportTable").jqGrid({
        url: '/CoreNetworkReports/CN4FinalReportListing',
        datatype: 'json',
        mtype: 'POST',
        colNames: ['Road Code', 'Road Name', 'DRRP Road Code', 'DRRP Road Name', 'Road Length (Kms)', 'Road From', 'Road To', 'Route Type', 'Length Covered (P/F)', 'Habitation', 'Population'],
        ...
        loadComplete: function () {
            ...
            $('#CN4FinalReportTable_rn').html('Sr.<br/>No.');
            $.unblockUI();
        },
        loadError: function (xhr, status, error) {
            if (xhr.responseText == "session expired") {
