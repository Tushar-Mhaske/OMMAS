$(document).ready(function () {
    ...
    $("#btnViewPhyProgressWork").click(function () {
        if ($('#frmPhyProgessWork').valid()) {
            $("#loadReport").html("");
            $("#BatchName").val($("#BatchList_PhyProgressWorkDetails option:selected").text());
            $("#CollaborationName").val($("#FundingAgencyList_PhyProgressWorkDetails option:selected").text());
            ...
            $.ajax({
                url: '/ProgressReport/Progress/PhysicalProgressWorkReport/',
                type: 'POST',
                catche: false,
