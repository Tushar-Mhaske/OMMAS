...
{
    public class AwardwisePayment
    {
        public AwardwisePayment()
        {
           ...
           PhaseYear = DateTime.Now.Year;
            PhaseYearList = new SelectList(commonFunctions.PopulateAllYears(DateTime.Now.Year), "Value", "Text").ToList();

            MonthCode = DateTime.Now.Month;
            MonthList = new SelectList(commonFunctions.PopulateMonths(true), "Value", "Text").ToList();
        ...
        public List<SelectListItem> AwardCodeList { get; set; }
