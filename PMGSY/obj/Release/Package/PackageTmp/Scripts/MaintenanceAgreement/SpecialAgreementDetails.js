...
$(document).ready(function () {
    ...
    $('#btnSaveAgreementDetails').click(function (e) {
        ...
        if ($('#frmAddAgreementDetails').valid()) {
            ...
            $.ajax({
                url: "/MaintenanceAgreement/AddSpecialAgreement",
                type: "POST",
    ...
    $("#btnUpdateAgreementDetails").click(function (e) {
        ...
        if ($("#frmAddAgreementDetails").valid()) {
            ...
            $.ajax({
                type: 'POST',
                url: '/MaintenanceAgreement/EditSpecialAgreementDetails',
                async: false,
                data: $("#frmAddAgreementDetails").serialize(),
                success: function (data) {
                    if (data.success == true) {
...
function LoadAgreementDetails() {
    ...
    jQuery("#tbAgreementList").jqGrid({
        url: '/MaintenanceAgreement/GetSpecialAgreementDetailsList_Proposal',
        datatype: "json",
        mtype: "POST",
...
function EditAgreementDetails(urlparameter) {
    ...
    $.ajax({
        type: 'GET',
        url: '/MaintenanceAgreement/EditSpecialAgreementDetails/' + urlparameter,
        dataType: "html",
        async: false,
        cache: false,
        success: function (data) {
...
function ViewAgreementMasterDetails(urlparameter) {
    ...
    $.ajax({
        type: 'GET',
        url: '/MaintenanceAgreement/ViewSpecialAgreementDetails/' + urlparameter,
        dataType: "html",
        async: false,
        cache: false,
        success: function (data) {
