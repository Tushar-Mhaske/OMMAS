...
$(function () {
    ...
    $('#fileupload').bind('fileuploadadd', function (e, data) {
        ...
        //    type: 'POST',
        //    url: '/MaintainanceInspection/ReadGeoPositions/',
        //    data: data.files[0],
        //    cache: false,
        //    processData: false,
        //    contentType: false,
...
function ListProposalFiles(IMS_PR_ROAD_CODE) {
    ...
    jQuery("#tbFilesList").jqGrid({
        url: '/MaintainanceInspection/ListFiles',
        datatype: "json",
        mtype: "POST",
        ...
        editurl: "/MaintainanceInspection/UpdateImageDetails",
...
function DownLoadImage(cellvalue) {
    var url = "/MaintainanceInspection/DownloadFile/" + cellvalue;
...
function DeleteFileDetails(param, IMS_FILE_NAME) {
    ...
    if (confirm("Are you sure to delete the Image and Image details ? ")) {
        ...
        $.ajax({
            url: "/MaintainanceInspection/DeleteFileDetails/",
            type: "POST",
            cache: false,
            data: {
            ...
            success: function (response) {
                ...
                $("#tbFilesList").trigger('reloadGrid');
                if (response.Success) {
                    alert("Maintainance Inspection Image and Image Details Deleted Succesfully.");
