...
var DEFAULT_URL = '/PdfViewer/web/UserManual.pdf';
...
PDFJS.imageResourcesPath = '/PdfViewer/web/images/';
  PDFJS.workerSrc = '/PdfViewer/build/pdf.worker.js';
  //PDFJS.cMapUrl = '/PdfViewer/web/cmaps/';
...
var PDFView = {
  ...
  setTitleUsingUrl: function pdfViewSetTitleUsingUrl(url) {
    this.url = url;
    try {
        this.setTitle("PMGSY");//decodeURIComponent(getFileName(url)) || url
    } catch (e) {
