$(document).ready(function () {
    ...
    $("#btnFinalize").click(function () {
        ...
        $.ajax({
            url: '/CoreNetwork/GetCoreNetworkChecksPMGSY3',
            type: "GET",
            datatype: "Json",
            cache: false,
            async: false,
            ...
            success: function (response) {
                unblockPage();
                if (response.Success) {
                    if (confirm("Once MRL/TR is Finalized, it can not be Edited and Deleted.\nAre you sure to Finalize it ?")) {
                        $.ajax({
...
function LoadHabitationGrid() {
    ...
    jQuery("#habitationDetailsCategory").jqGrid({
        ...
        colModel: [
                            ...
                            { name: 'HabDirect', index: 'HabDirect', width: 200, sortable: false, align: "center" },
                            { name: 'HabVerified', index: 'HabVerified', width: 200, sortable: false, align: "center" },
...
function LoadMappedRoadsListDetails(PLAN_CN_ROAD_CODE) {
    ...
    jQuery("#tbMappedDRRPList").jqGrid({
        ...
        loadComplete: function (data) {
            //alert(jQuery("#tbMappedDRRPList").jqGrid('getGridParam', 'records'));
