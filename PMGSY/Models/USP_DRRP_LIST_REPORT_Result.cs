...
namespace PMGSY.Models
{
    ...
    public partial class USP_DRRP_LIST_REPORT_Result
    {
        ...
        public Nullable<int> MAST_TI_YEAR { get; set; }
        public Nullable<int> MAST_TOTAL_TI { get; set; }
        public Nullable<int> MAST_COMM_TI { get; set; }
        public Nullable<int> MAST_SURFACE_SEG_NO { get; set; }
        public Nullable<decimal> MAST_ER_STR_CHAIN { get; set; }
        public Nullable<decimal> MAST_ER_END_CHAIN { get; set; }
        public Nullable<decimal> MAST_ER_SURFACE_LENGTH { get; set; }
