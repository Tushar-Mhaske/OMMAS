$(document).ready(function () {
    ...
    $("#btnReadKPIPMAwardsDetails").click(function () {                  // CHANGES MADE ON 18-08-2022


        $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif" />' });
        $.ajax({
            url: '/EmargDataPull/EmargDataPull/GetKPIPMAwardsDetails/',
            type: 'POST',
            catche: false,
    ...
    // Added By bhushan on 05-12-2022
    $("#btnCancelChequeDetails").click(function () {


        $.blockUI({ message: '<img src="/Content/images/ajax-loader.gif" />' });
        $.ajax({
            url: '/EmargDataPull/EmargDataPull/CancelChequePayment/',
            type: 'POST',
            catche: false,
            //       data: $("#frmPackageWiseReport").serialize(),
            async: false,
