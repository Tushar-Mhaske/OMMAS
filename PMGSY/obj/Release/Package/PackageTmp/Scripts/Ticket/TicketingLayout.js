...
function DisplayPendingLicketList()
{
    ...
    $("#tbTicketList").jqGrid({
        ...
        mtype: "POST",
        datatype: "json",
        colNames: ['Ticket No.', 'State', 'Category', 'Module', 'Subject', 'Reported By', 'Reported Date', 'Approval Date', 'First Forwarded To','Status', 'Currently Pending At', 'Upload File', 'View', 'Reply'],
        colModel: [
...
function DisplayAllLicketList() {
    ...
    $("#tbAllTicketList").jqGrid({
        ...
        mtype: "POST",
        datatype: "json",
        colNames: ['Ticket No.', 'State', 'Category', 'Module', 'Subject', 'Reported By', 'Reported Date', 'Approval Date', 'First Forwarded To', 'Status', 'Currently Pending At', 'Closing Date', 'View'],
        colModel: [
            { name: 'TicketNo', index: "TicketNo", key: true, width: 70, hidden: false, search: false, align: 'center' },
            { name: 'State', index: "State", width: 130, sortable: false, resizable: false, search: true, align: 'center' },
