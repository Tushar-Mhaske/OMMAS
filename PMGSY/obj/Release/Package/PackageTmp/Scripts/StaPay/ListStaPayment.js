$(document).ready(function () {
    ...
    $("#btnGo").click(function () {                
        blockPage();
        if (validate()) {
            $("#divStaPayment").load('/StaPay/StaPaymentList/' + $("#ddlState").val() + "$" + $("#ddlImsYear").val() + "$" + $("#ddlImsBatch").val() + "$" + $("#ddlImsStreams").val() + "$" + $("#ddlImsProposalTypes").val() + "$" + $("#ddlImsProposalSchemes").val(), function () {
                unblockPage();
            });
        }
        unblockPage();
