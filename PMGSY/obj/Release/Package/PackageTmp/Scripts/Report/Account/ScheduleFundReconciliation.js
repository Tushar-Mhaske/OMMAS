...
$(document).ready(function () {
    ...
    $("#btnView").click(function () {
        ...
        if ($("#rdbAnnual").is(":checked")) {
            data = { srrdaNDCode: $("#Agency option:selected").val(),month: 0, year: $("#Year option:selected").val(),rlevel:reportLevel }
            loadReconciliationGrid(data);
        }

        if ($("#rdbMonth").is(":checked")) {
            data = { srrdaNDCode: $("#Agency option:selected").val(), month: $("#Month option:selected").val(), year: $("#Year option:selected").val(),rlevel:reportLevel }
            loadReconciliationGrid(data);
