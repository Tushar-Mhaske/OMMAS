...
{
    public class EFORM_QM_TEST_RESULT_VERIFICATION_DETAILS
    {
        ...
        [Required(ErrorMessage = "Page-8: Item 3. ATTENTION TO QUALITY- II. (c) Verification of test results table- Please select Results of the test conducted by QM at a defined location.(C / N) of row ")]
        ...
        [FieldType(PropertyType = PDFFieldType.TextBox)]
        [Required(ErrorMessage = "Page-8: Item 3. ATTENTION TO QUALITY- II. (c) Verification of test results table- Please enter Test results as per QCR-I at the nearest location of row ")]
        [StringLength(250, ErrorMessage = "Page-8: Item 3. ATTENTION TO QUALITY- II. (c) Verification of test results table- The length must be 250 character or less for Test results as per QCR-I at the nearest location of row ")]
        ...
        [FieldType(PropertyType = PDFFieldType.RadioButton)]
        [Required(ErrorMessage = "Page-8: Item 3. ATTENTION TO QUALITY- II. (c) Verification of test results table- Please select  Results of the test conducted previously by QM at defined location.(C / N) of row ")]
