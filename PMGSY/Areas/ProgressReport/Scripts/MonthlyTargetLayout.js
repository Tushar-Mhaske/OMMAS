$(document).ready(function () {
    ...
    $.validator.unobtrusive.parse('#frmMonthlyTarget');
    ...
    if ($("#frmMonthlyTarget").valid()) {
        ...
        $.ajax({
            url: "/ProgressReport/Progress/MonthlyTargetReport/",
            cache: false,
            type: "POST",
            async: false,
            data: $("#frmMonthlyTarget").serialize(),
    ...
    $("#btnViewMonthlyTargetReport").click(function () {
