...
namespace PMGSY.Models.MasterDataEntry
{
    public class FacilitySearch
    {
        ...
        [Display(Name = "Block")]
        [Range(0, 2147483647, ErrorMessage = "Please Select Block.")]
        ...
        [Range(0, 2147483647, ErrorMessage = "Please Select Facility Category.")]
        public int facilityCode { get; set; }

        [Display(Name = "Facility Type")]
        //[Required(AllowEmptyStrings=false,ErrorMessage="Please Enter Facility Name")]
        [Range(0, 2147483647, ErrorMessage = "Please Select facility Type.")]
        ...
        [Range(0, 2147483647, ErrorMessage = "Please Select Habitation.")]
