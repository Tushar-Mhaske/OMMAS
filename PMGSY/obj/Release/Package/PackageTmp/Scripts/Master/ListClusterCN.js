...
$(document).ready(function () {
    ...
    if (!$("#ClusterSearchDetails").is(":visible")) {
        ...
        $('#ClusterSearchDetails').load('/Master/SearchClusterCN');
    ...
    $('#btnAdd').click(function (e) {
        ...
        $('#ClusterAddDetails').load("/Master/AddEditClusterCN");
...
function DeleteClusterDetails(urlparameter) {
    if (confirm("Are you sure you want to delete Cluster details?")) {
        ...
        $.ajax({
            type: 'POST',
            url: '/Master/DeleteClusterCN/' + urlparameter,
            dataType: 'json',
            async: false,
            cache: false,
...
function EditClusterDetails(urlparameter) {
    ...
    $('#dvEditCluster').empty();
    $("#dvEditCluster").load("/Master/EditClusterCN/" + urlparameter, function () {
...
function ViewClusterDetails(urlparameter) {
    ...
    $.ajax({
        type: 'GET',
        url: '/Master/ViewClusterCNHabitation/' + urlparameter,
        dataType: "html",
        async: false,
        cache: false,
        success: function (data) {
