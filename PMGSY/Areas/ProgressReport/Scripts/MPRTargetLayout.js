$(document).ready(function () {
    ...
    $.validator.unobtrusive.parse('#frmMPRTarget');
    ...
    if ($("#frmMPRTarget").valid()) {
        ...
        $.ajax({
            url: "/ProgressReport/Progress/MPRTargetReport/",
            cache: false,
            type: "POST",
            async: false,
            data: $("#frmMPRTarget").serialize(),
    ...
    $("#btnViewMPRTargetReport").click(function () {
